...
import 'package:rcu_assistant/configs/app_legend.dart';

class ChartsScreen extends StatelessWidget {
  const ChartsScreen({super.key});

  final pilateColor = AppColors.mainBlueColor;
  final cyclingColor = AppColors.warningColor;
  final quickWorkoutColor = AppColors.dangerColor;
